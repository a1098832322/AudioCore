 ...
 * @since 2018年8月21日
 */
public class ConvertingAnyAudioToMp3Sync {

    /**
     * 任意格式转码成MP3格式
     *
     * @param source   第一个参数source表示要解码的源文件。
     *                 <p>
     * @param target   第二个参数target是将要创建和编码的目标文件。
     *                 <p>
     *                 <p>
     *                 请注意，此方法是阻塞的：只有在转码操作完成（或失败）后，该方法才会返回
     * @param listener 转码监听器
     * @return boolean
     */
    public static boolean convertingAnyAudioToMp3WithAProgressListener(File source, File target, EncoderProgressListener listener) {
